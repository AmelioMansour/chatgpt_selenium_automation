...
class ChatGPTAutomation:
    ...
    def launch_chrome_with_remote_debugging(self, port, url):
        ...
        def open_chrome():
            ...
            logger.debug("Running command: %s", chrome_cmd)
    ...
    def wait_for_human_verification():
        ...
        while True:
            ...
            if user_input == 'y':
                ...
                logger.debug("Waiting for user verification to complete")
                time.sleep(5)  # You can adjust the waiting time as needed
            else:
                print("Invalid input. Please enter 'y' or 'n'.")
                logger.debug("Received invalid input during verification: %s", user_input)
